...
<body>
    ...
    <form class="formNew" action="../controller/alquiler.php" method="post">
            <legend>Nuevo Lugar de Alquiler</legend>
            <div>
                ...
                <div class="form_campo">
                    ...
                    <input id="precio" name="precio" class="form_text" type="text" 
                    placeholder="Ingrese el precio del Lugar">
                </div>

                <div class="form_campo">
                    <label for="disponibilidad">Disponibilidad: </label>
                    <input id="disponibilidad" name="disponibilidad" class="form_text" type="text" 
