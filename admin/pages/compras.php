...
<body>
    ...
    <section class="contenedor contenido">
        ...
        <div class="h_compras">
            <h2>Comprar</h2>
            <div class="b_compras">
                <a class="boton" href="compras_nueva.php">Nuevo Lugar Para Comprar</a>
            </div>
        </div>

        <?php $compras = Compra::getAll(); ?>

        <?php if (empty($compras)) {  ?>
            <div>
                <p class="text-primary">No hay lugares para comprar en el sistema.</p>
            </div>
        <?php } else { ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($compras as $compra) {
                            ...
                            echo "<td>" . $compra->getTitulo() . "</td>";
                            echo "<td>" . $compra->getDireccion() . "</td>";
                            echo "<td>" . $compra->getCaracteristicas() . "</td>";
                            echo "<td>" . $compra->getContacto() . "</td>";
